#!/bin/bash
#SBATCH --job-name=sam3_frz
#SBATCH --account=ACD114147
#SBATCH --output=/work/nthujerry123/sam3/sam3_v2/experiments/stage2B_generalization_frozen/logs/train_%j.out
#SBATCH --error=/work/nthujerry123/sam3/sam3_v2/experiments/stage2B_generalization_frozen/logs/train_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p /work/nthujerry123/sam3/sam3_v2/experiments/stage2B_generalization_frozen/checkpoints

echo "--- Starting SAM3 Stage 2B (Generalization - Frozen Backbones) Training ---"
# Start background disk monitor to prevent disk full issues
python3.11 /work/nthujerry123/sam3/sam3_v2/utils/disk_monitor.py \
    --dir /work/nthujerry123/sam3/sam3_v2/experiments/stage2B_generalization_frozen/checkpoints \
...
python3.11 train/train.py \
    -c configs/stage2B_generalization_frozen.yaml \
    --use-cluster 0 \
    --num-gpus 1 \
    --num-nodes 1
